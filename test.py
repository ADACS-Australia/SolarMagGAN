...
parser.add_argument(
    "--train_input", help="folder name of training input data", default="AIA"
)
parser.add_argument(
    "--train_output", help="folder name of training  outpu data", default="HMI"
)
parser.add_argument("--test_input", help="folder name of input data", default="STEREO")
