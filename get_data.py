...
email = "dliptai@swin.edu.au"
# can make multiple queries and save the details to files based on the AR and
# retrieve the data later

parser = argparse.ArgumentParser()
parser.add_argument("--AIA", help="download AIA if set", action="store_true")
parser.add_argument("--HMI", help="download HMI if set", action="store_true")
parser.add_argument("--STEREO", help="download STEREO if set", action="store_true")
parser.add_argument(
...
parser.add_argument(
    "--cadence", help="AIA and HMI cadence in hours", type=int, default=12
)
parser.add_argument(
    "--AIA_path", help="directory to store AIA data", default="./FITS_DATA/AIA"
)
parser.add_argument(
    "--HMI_path", help="directory to store HMI data", default="./FITS_DATA/HMI"
)
parser.add_argument(
    "--STEREO_path", help="directory to store STEREO data", default="./FITS_DATA/STEREO"
)
parser.add_argument(
    "--STEREO_start", help="start time for STEREO", default="2011/01/01 00:00:00"
)
parser.add_argument(
    "--STEREO_end", help="end date for STEREO", default="2017/01/01 00:00:00"
)
parser.add_argument(
    "--STEREO_cadence", help="download 1 in every n images", type=int, default=100
)
parser.add_argument(
